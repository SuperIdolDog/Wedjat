...
namespace ViewWindow
{
    public class ViewWindow : Model.IViewWindow
    {
        ...
        public void ClearWindow()
        {
            ...
            //清空显示的txt
            _hWndControl.clearHObjectTxtList();
        }
        ...
        public void dispCross(bool status)
        {
            _hWndControl.IsDispCross = status;
        }
        ...
        #region 专门用于 显示Txt文本
        public void displayTxt(string txt, string color, int fontSize)
        {
            _hWndControl.DispTxt(txt, color, fontSize);
        }
        public void displayTxt(string obj, string color)
        {
            _hWndControl.DispTxt(obj, color);

        }
        public void displayTxt(string txt, int fontSize)
        {
            _hWndControl.DispTxt(txt, fontSize);
        }
        public void displayTxt(string txt)
        {
            _hWndControl.DispTxt(txt);
        }
